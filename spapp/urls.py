...
urlpatterns = [
    ...
    path('reset-password', auth_views.PasswordResetView.as_view(template_name='pages/auth/email_form.html'),
         name='reset-password'),
...
urlpatterns += [
    ...
    path("manager/delete/degree/<int:pk>",
         views.delete_degree, name="delete_degree"),
    path("manager/delete/major/<int:pk>",
         views.delete_major, name="delete_major"),
    path("manager/delete/job/<int:pk>", views.delete_job, name="delete_job"),
    path("manager/delete/emphasis/<int:pk>",
         views.delete_emphasis, name="delete_emphasis"),
    path("manager/delete/validator/<int:pk>",
         views.delete_validator, name="delete_validator"),
    ...
    path("manager/edit/emphasis/<int:pk>",
         views.edit_emphasis, name="edit_emphasis"),
    path("manager/update/emphasis", views.update_emphasis, name="update_emphasis"),


    path("manager/edit/validator/<int:pk>",
         views.edit_validator, name="edit_validator"),
    path("manager/update/validator",
         views.update_validator, name="update_validator")
